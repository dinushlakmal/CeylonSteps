...
class CeylonStepsApp : Application() {

    val database by lazy { AppDatabase.getDatabase(this) }
    val repository by lazy { TripRepository(database.tripLocationDao()) }
    val timelineRepository by lazy { com.ceylonsteps.travelapp.data.repository.TripTimelineRepository(database.tripTimelineDao()) }
    ...
    override fun onCreate() {
        ...
        Configuration.getInstance().userAgentValue = "CeylonSteps/1.0 (Android; OpenStreetMap)"
